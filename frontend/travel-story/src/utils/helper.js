...
import NO_SEARCH_DATA_IMG from "../assets/images/no-results.svg";
import NO_FILTER_IMG from "../assets/images/no-connection.svg";
...
export const getEmptyCardMessage = (filterType) => {
  switch (filterType) {
    ...
    default:
      return `Start creating your first Travel Story! Click the 'Add' button to jot down your thought, idea, and memories. Let's get started!`;
  }
};
